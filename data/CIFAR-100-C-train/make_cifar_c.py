# -*- coding: utf-8 -*-
'''produce cifar-10-trainset-c use imagenet-c corruptions '''
import os
import sys
...
def frost(x, severity=1):
    ...
    filename = ['/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost1.png', '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost2.png', '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost3.png', '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost4.png', '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost5.png', '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost6.png'][idx]
    # filename = ['./frost_6img/frost1.png', './frost_6img/frost2.png', './frost_6img/frost3.png', './frost_6img/frost4.png', './frost_6img/frost5.png', './frost_6img/frost6.png'][idx]
    
    # filename = '/data/liangjiachen/CIFAR-10-C-train/frost_6img/frost6.png'
    frost1 = cv2.imread(filename)
    
    if frost1 is None:
        print(filename)

    # frost1 = frost1.resize([int(32 * 0.2), int(32 * 0.2)], PILImage.BOX)
    frost1 = cv2.resize(frost1, (0, 0), fx=0.2, fy=0.2)
    # randomly crop and convert to rgb
    x_start, y_start = np.random.randint(0, frost1.shape[0] - 32), np.random.randint(0, frost1.shape[1] - 32)
    frost1 = frost1[x_start:x_start + 32, y_start:y_start + 32][..., [2, 1, 0]]

    return np.clip(c[0] * np.array(x) + c[1] * frost1, 0, 255)
...
root = '../'
test_data = dset.CIFAR100(root, train=True, download=True)
...
for method_name in d.keys():
    ...
    np.save('/data/liangjiachen/CIFAR-100-C-train/' + d[method_name].__name__ + '.npy',
            np.array(cifar_c).astype(np.uint8))

    np.save('/data/liangjiachen/CIFAR-100-C-train/labels.npy',
